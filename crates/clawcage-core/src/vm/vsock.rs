...
// Re-export protocol types from clawcage-proto.
pub use clawcage_proto::{
...
/// vsock port for port watcher (listening port detection from guest).
...
define_class!(
    ...
    #[name = "ClawcageVsockListenerDelegate"]
    #[ivars = DelegateIvars]
