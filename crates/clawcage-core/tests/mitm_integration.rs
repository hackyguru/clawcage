...
use clawcage_core::net::mitm_proxy::{self, MitmProxyConfig};
use clawcage_core::net::policy::{DomainMatcher, NetworkPolicy, PolicyRule};
use clawcage_logger::{DbWriter, Decision};
...
/// Build a rustls ClientConfig that trusts the Clawcage MITM CA.
...
/// with `cargo test -p clawcage-core -- --ignored mitm_proxy_download_throughput`.
#[tokio::test]
