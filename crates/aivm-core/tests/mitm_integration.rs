...
use aivm_core::net::policy::{DomainMatcher, NetworkPolicy, PolicyRule};
use aivm_logger::{DbWriter, Decision};
...
/// Build a rustls ClientConfig that trusts the Aivm MITM CA.
...
/// with `cargo test -p aivm-core -- --ignored mitm_proxy_download_throughput`.
#[tokio::test]
