/// Integration tests for aivm-logger: write+read roundtrips, batching,
...
fn fixture_reader() -> DbReader {
    ...
    path.pop(); // crates/aivm-logger -> crates
...
async fn net_event_roundtrip() {
    ...
    let reader = aivm_logger::DbReader::open(&path).unwrap();
...
// aivm-logger audit. Written before fixes (TDD red phase).
// ========================================================================
