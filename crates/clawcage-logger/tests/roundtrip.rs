/// Integration tests for clawcage-logger: write+read roundtrips, batching,
...
fn fixture_reader() -> DbReader {
    ...
    path.pop(); // crates/clawcage-logger -> crates
...
async fn net_event_roundtrip() {
    ...
    let reader = clawcage_logger::DbReader::open(&path).unwrap();
...
// clawcage-logger audit. Written before fixes (TDD red phase).
// ========================================================================
