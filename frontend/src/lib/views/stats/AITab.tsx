                          ...
                          <div key={call.id} className="space-y-1">
                            ...
                            {callTools.map((tc) => {
                              ...
                              return (
                                ...
                                >
                                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="size-3 text-caution shrink-0"><path d="M13 2 3 14h9l-1 8 10-12h-9l1-8z" /></svg>
