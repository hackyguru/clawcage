    ...
    <div className="space-y-3">
      ...
      {!!data.arguments && (
        <div>
          ...
          <pre
            className="text-xs font-mono bg-base-200 rounded p-2 overflow-auto max-h-60"
      ...
      {!!data.response_preview && (
        <div>
          ...
          <pre className="text-xs font-mono bg-base-200 rounded p-2 overflow-auto max-h-60">
            {str(data.response_preview)}
          </pre>
        </div>
      )}
      {data.is_error ? (
        <div className="badge bg-denied/15 text-denied badge-sm">Error</div>
      ) : null}
    </div>
  );
    ...
    <div className="space-y-3">
      ...
      {!!data.request_body_preview && (
        <div>
          ...
          <pre className="text-xs font-mono bg-base-200 rounded p-2 overflow-auto max-h-40">
